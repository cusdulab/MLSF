...
plot(d[,"pbindaff"], d[,"predicted"], xlim=xylim, ylim=xylim, xlab="Measured binding affinity", ylab="Predicted binding affinity by Cyscore", main=sprintf("N=%d, RMSE=%.2f, Rp=%.3f, Rs=%.3f", n, rmse, pcor, scor))
