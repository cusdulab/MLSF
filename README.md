...
Code and data for reproducing the results of machine-learning scoring functions vs classical scoring functions on similarity-based benchmarks, presented in the papers by Li et al. [1-2].
